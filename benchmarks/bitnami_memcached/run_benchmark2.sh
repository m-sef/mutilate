...
run_benchmark() {
    ...
    sudo kubectl exec -n mutilate mutilate-leader-0 -- ./scripts/mutilate_leader/modified_run_workload.sh $1 $2 2 >> $SCRIPT_DIR/$TEMP_DIR/$UPDATE\_$QPS/leader.log
...
for i in 40000 80000 120000 160000 200000; do
